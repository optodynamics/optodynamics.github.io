...
•	Design and implementation of a custom confocal laser scanning microscope, optimized for measuring molecular diffusion with fluorescence fluctuation spectroscopy (FFS) by combining pulsed excitation with state-of-the-art array detectors and photon time-tagging
...
This position is funded by the European Union through the ERC starting grant project Comprehensive Platform for Correlating Biomolecular Dynamics and Biomechanics with Multiscale Optical Spectroscopy (MotionPicture), No. 101219234.
...
This fellowship is a software-engineering role with a strong focus on scientific computing and reproducible open-source development. Within the research team, your main responsibilities will be:

•	Development of a software framework for simulating realistic fluorescence fluctuation spectroscopy data (FFS)
•	implementation of a data analysis framework for robust, autonomous, and real-time data evaluation for FFS
...
Application’s deadline: The position will remain open until March 31st, 2026.
